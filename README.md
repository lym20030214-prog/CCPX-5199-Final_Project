...
> **Note on data access: These are ICPSR Add Health public-use files, freely available after creating an ICPSR MyData account and agreeing to the Terms of Use. They are not included in this repository — download from https://www.icpsr.umich.edu/web/ICPSR/studies/21600 and place them at the paths listed below.
